            ...
            <div class="relative flex items-center gap-3">
                <div class="relative flex-1 group">
                    <input
                        ...
                        class="peer w-full pl-16 pr-4 py-4 text-[14px] font-black border border-slate-50 rounded-2xl focus:border-indigo-400 focus:ring-4 focus:ring-indigo-500/5 bg-slate-50/50 transition-all uppercase tracking-tight outline-none"
                        autocomplete="off">
                    <svg class="absolute left-6 top-1/2 -translate-y-1/2 w-5 h-5 text-indigo-300 peer-focus:text-indigo-500 transition-colors duration-300" 
