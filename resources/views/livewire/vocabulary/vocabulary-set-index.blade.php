            ...
            <div class="flex flex-col gap-3 pt-6 border-t border-slate-50">
                ...
                <div class="flex gap-2">
                    ...
                    <button 
                        ...
                        wire:confirm="BẠN CÓ CHẮC CHẮN MUỐN XOÁ BỘ TỪ NÀY? HÀNH ĐỘNG NÀY KHÔNG THỂ HOÀN TÁC."
                        class="p-3.5 bg-rose-50 text-rose-600 rounded-2xl hover:bg-rose-100 transition-colors active:scale-95 border border-rose-100"
                        title="Xoá bộ từ"
                    >
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
