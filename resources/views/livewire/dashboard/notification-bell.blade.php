<div x-data="{ open: false }" class="relative perspective-1000">
    ...
    <button @click="open = !open; if(open) $wire.$refresh()" 
            class="relative p-2.5 rounded-2xl bg-white border border-slate-100 antigravity-floating hover:shadow-xl hover:-translate-y-1 hover:bg-slate-50 transition-all duration-300 group focus:outline-none focus:ring-4 focus:ring-indigo-500/5">
