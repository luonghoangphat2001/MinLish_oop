<div>
    <div class="mb-6 flex flex-wrap items-center justify-between gap-3 rounded-xl border bg-white p-5 shadow-sm">
        <h2 class="text-2xl font-semibold text-gray-800">Dashboard học tập</h2>
        <div class="flex flex-wrap gap-2">
            <a href="{{ route('learning.daily-quiz') }}"
               class="inline-flex items-center rounded-lg border px-4 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-50">
                Daily Quiz
            </a>
